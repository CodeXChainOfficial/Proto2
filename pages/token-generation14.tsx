...
import styles from "./token-generation14.module.css";
const TokenGeneration14: NextPage = () => {
  return (
              ...
              <div className={styles.frameGroup}>
                <div className={styles.networkParent}>
                  <div className={styles.frameParent2}>
                    ...
                    <div className={styles.frameParent3}>
                      <div className={styles.networkParent}>
                        <div className={styles.network}>Support threshold</div>
                        <div className={styles.network}>
                      ...
                      <div className={styles.networkParent}>
                        ...
                        <div className={styles.wrapper}>
                          <div className={styles.network}>{`> 50% (>1%)`}</div>
                        </div>
                        <div className={styles.wrapper}>
                          <div className={styles.network}>
...
export default TokenGeneration14;
